...
<footer class="footer bg-gray-800 p-4  bottom-0 left-0 right-0 z-index-1">
  <div class="flex justify-between items-center">
    <div class="logo-and-name flex items-center">
      ...
      <span class="text-lg font-bold text-white">Shopping-Svelte</span>
    </div>
    <div class="my-info text-right">
      <span class="text-white">SAIFBABA </span>
      <a href="https://github.com/saiifbaba/shopping_svelte.git" class="text-white github">GitHub Link</a>
    </div>
  </div>
</footer>